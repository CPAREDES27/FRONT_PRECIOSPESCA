		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Precios Ponderados",
									"targetURL": "#PreciosPonderados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PreciosPonderados-display": {
								"semanticObject": "PreciosPonderados",
								"action": "display",
								"description": "Módulo de precios ponderados",
								"title": "Precios Ponderados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.preciosponderados",
									"url": sap.ui.require.toUrl("tasa/com/preciosponderados")
								}
							}
						}
					}
