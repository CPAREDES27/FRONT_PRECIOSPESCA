		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Castigos Propuestos al precio",
									"targetURL": "#CastigosPropuestosalprecio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CastigosPropuestosalprecio-display": {
								"semanticObject": "CastigosPropuestosalprecio",
								"action": "display",
								"description": "Módulo Castigos Propuestos al precio",
								"title": "Castigos Propuestos al precio",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.castigospropuestos",
									"url": sap.ui.require.toUrl("tasa/com/castigospropuestos")
								}
							}
						}
					}
