		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Politicadeprecios-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Politicadeprecios-display": {
								"semanticObject": "Politicadeprecios",
								"action": "display",
								"description": "Modulo de políticas de precio",
								"title": "Politica de precios",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.tasa.politicadeprecios",
									"url": sap.ui.require.toUrl("com/tasa/politicadeprecios")
								}
							}
						}
					}
