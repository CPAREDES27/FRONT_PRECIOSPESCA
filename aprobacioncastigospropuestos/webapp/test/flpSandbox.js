		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aprobacion Castigos Propuestos",
									"targetURL": "#AprobacionCastigosPropuestos-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AprobacionCastigosPropuestos-display": {
								"semanticObject": "AprobacionCastigosPropuestos",
								"action": "display",
								"description": "Modulo de aprobación castigos propuestos",
								"title": "Aprobacion Castigos Propuestos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.aprobacioncastigospropuestos",
									"url": sap.ui.require.toUrl("tasa/com/aprobacioncastigospropuestos")
								}
							}
						}
					}
