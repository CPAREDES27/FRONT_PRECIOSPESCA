		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consulta de Horometros",
									"targetURL": "#ConsultadeHorometros-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ConsultadeHorometros-display": {
								"semanticObject": "ConsultadeHorometros",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.horometros",
									"url": sap.ui.require.toUrl("tasa/com/horometros")
								}
							}
						}
					}
