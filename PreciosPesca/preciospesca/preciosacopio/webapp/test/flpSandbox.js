		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Precios de Acopio",
									"targetURL": "#PreciosdeAcopio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PreciosdeAcopio-display": {
								"semanticObject": "PreciosdeAcopio",
								"action": "display",
								"description": "Módulo precios de acopio",
								"title": "Precios de Acopio",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.preciosacopio",
									"url": sap.ui.require.toUrl("tasa/com/preciosacopio")
								}
							}
						}
					}
