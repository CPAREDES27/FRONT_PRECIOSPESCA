		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Estado de precios",
									"targetURL": "#Estadodeprecios-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Estadodeprecios-display": {
								"semanticObject": "Estadodeprecios",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.estadodeprecios",
									"url": sap.ui.require.toUrl("tasa/com/estadodeprecios")
								}
							}
						}
					}
