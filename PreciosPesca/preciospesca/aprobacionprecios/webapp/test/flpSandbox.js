		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aprobacion de Precios",
									"targetURL": "#AprobaciondePrecios-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AprobaciondePrecios-display": {
								"semanticObject": "AprobaciondePrecios",
								"action": "display",
								"description": "Módulo de aprobación de precios",
								"title": "Aprobacion de Precios",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.aprobacionprecios",
									"url": sap.ui.require.toUrl("tasa/com/aprobacionprecios")
								}
							}
						}
					}
