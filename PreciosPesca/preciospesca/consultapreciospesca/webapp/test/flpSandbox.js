		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consulta Precios de Pesca",
									"targetURL": "#ConsultaPreciosdePesca-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ConsultaPreciosdePesca-display": {
								"semanticObject": "ConsultaPreciosdePesca",
								"action": "display",
								"description": "Módulo consulta precios de pesca",
								"title": "Consulta Precios de Pesca",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tasa.com.consultapreciospesca",
									"url": sap.ui.require.toUrl("tasa/com/consultapreciospesca")
								}
							}
						}
					}
